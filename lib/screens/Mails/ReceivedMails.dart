...
class ReceivedMails extends StatefulWidget {
  @override
  _ReceivedMailsState createState() => _ReceivedMailsState();
}

class _ReceivedMailsState extends State<ReceivedMails> {
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              stream: _chatsCollection
                  .where('sender', isEqualTo: _selectedRecipientEmail )
                  .where('receiver', isEqualTo: _currentUserEmail)
